       ...
       for (var y = 0; y < len; y++) {
         for (var z = 0; z < len; z++) {
           ...
           // console.log("x : " + x + " y : " + y + " z : " + z);
            my.utlWebGL.drwSquare(this.trgt, [x - len / 2, y, z - len / 2], this.camPos, {x: aglX, y: aglY}, "https://github.com/amechanKyobo/3DRPG/blob/main/img/cubetexture.png?raw=true");
         }
       }
     }

     // my.utlWebGL.drwSquare(this.trgt, [0, 0, 0], this.camPos, {x: aglX, y: aglY}, "../img/sample.png");
   }
